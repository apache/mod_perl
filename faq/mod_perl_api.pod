...
=head1 I get syntax errors when I define a PerlRequire for a location

PerlRequire can't be inside <Location>.  There should only be one
PerlRequire in httpd.conf, at the top-level.
